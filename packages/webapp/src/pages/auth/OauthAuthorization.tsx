          ...
          <div className="mb-10">
            <div className="mb-4">
              ...
              <div className="mt-1 text-[13px] text-[#8a94a6]">
                Retrieve data about all the workspaces in your Forms account
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="mt-1 text-[13px] text-[#8a94a6]">
                Retrieve data about all the project in your Forms workspace
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="mt-1 text-[13px] text-[#8a94a6]">
                Retrieve data about all the forms in your Forms project
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <div className="mt-1 text-[13px] text-[#8a94a6]">
                Retrieve your Forms account information
              </div>
            </div>
          </div>
